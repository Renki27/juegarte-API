...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2020 a las 00:41:23
...
(1, 3, 'question text example', 'question information', '/uploads/s_img_q1.png'),
...
(5, 3, 'question text example', 'question information', '../uploads/s_img_q5.jpg'),
(6, 2, 'Primera pregunta respuesta verdadera', 'La respuesta a esta pregunta es verdadera', '../uploads/s_img_q1'),
(7, 2, 'Segunda pregunta respuesta falsa', 'La respuesta a esta pregunta es falsa', '../uploads/s_img_q2'),
(8, 3, '¿Cuál Artista fue el creador de la famosa pintura \"El Grito\"?', 'El grito (en noruego Skrik) es el título de cuatro cuadros del noruego Edvard Munch (1863-1944). La versión más famosa se encuentra en la Galería Nacional de Noruega y fue completada en 1893.​ Otras dos versiones del cuadro se encuentran en el Museo Munch.', '../uploads/s_img_q6.jpg');
...
(1, 1, '1st question text', '1st question info', '../uploads/image.png', '1', '2', '3', '4', '1'),
(2, 1, '2nd question text', '2nd question info', '../uploads/image.png', '1', '2', '3', '4', '2'),
(3, 1, '3rd question text', '3rd question info', '../uploads/image.png', '1', '2', '3', '4', '3'),
(4, 1, '4th question text', '4th question info', '../uploads/image.png', '1', '2', '3', '4', '4');
...
(5, 3, 'question text example', 'question information', '../uploads/s_img_q5.jpg', '1', '2', '3', '4', '2'),
(8, 3, '¿Cuál Artista fue el creador de la famosa pintura \"El Grito\"?', 'El grito (en noruego Skrik) es el título de cuatro cuadros del noruego Edvard Munch (1863-1944). La versión más famosa se encuentra en la Galería Nacional de Noruega y fue completada en 1893.​ Otras dos versiones del cuadro se encuentran en el Museo Munch.', '../uploads/s_img_q6.jpg', 'Edvard Munch', 'Leonardo da Vinci', 'Salvador Dalí', 'Vincent van Gogh', 'Edvard Munch');
...
(6, 2, 'Primera pregunta respuesta verdadera', 'La respuesta a esta pregunta es verdadera', '../uploads/tf_1.jpg', 'true'),
(7, 2, 'Segunda pregunta respuesta falsa', 'La respuesta a esta pregunta es falsa', '../uploads/tf_2.jpg', 'false');
...
--
ALTER TABLE `question`
  MODIFY `ID_QUESTION` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
